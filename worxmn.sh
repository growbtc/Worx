...
COIN_TGZ='https://github.com/mrgrow2k/Worx/releases/download/1.4.0/Worx-1.4.0-64bit-Linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='worx'
COIN_PORT=3300
RPC_PORT=31313
COIN_BLOCKS='https://github.com/mrgrow2k/Worx/releases/download/1.4.0/bootstrap.zip'
